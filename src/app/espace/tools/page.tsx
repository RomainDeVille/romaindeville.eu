  ...
  return (
    <div className="wrap">
      <header className="phead">
        ...
        <h1 className="title">Analyse <span className="gradient-text">multi-outils</span></h1>
        <p>Choisissez un profil ou des outils, lancez tout en parallele, recevez un rapport unifie au format constant.</p>
      </header>
