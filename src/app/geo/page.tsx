...
export const metadata: Metadata = {
  title: "GEO : visibilité dans les réponses des IA",
  description:
    "Generative Engine Optimization : faites de votre marque une source que ChatGPT, Perplexity, Gemini et Google AI Overviews citent. Audit GEO avec plan d'action priorisé, par Romain De Ville, consultant à Bruxelles.",
